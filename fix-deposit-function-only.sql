-- Fix ONLY the deposit_tokens function
-- This is the specific function causing the ambiguous column reference error
...
SELECT 'deposit_tokens function fixed!' as status;
