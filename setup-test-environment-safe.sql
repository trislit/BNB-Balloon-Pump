-- =================================================
-- PURE SUPABASE TEST ENVIRONMENT - SAFE VERSION
...
BEGIN
  ...
  FOR round_num IN 1..rounds_to_test LOOP
    -- Set pop chance for current round (game will auto-reset when balloon pops)
...
-- Insert some sample data for testing (ignore conflicts)
